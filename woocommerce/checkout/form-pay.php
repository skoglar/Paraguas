	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'paraguas' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'paraguas' ); ?></th>
			</tr>
		</thead>
		<tbody>

...
- The `/css/theme.css` and its minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
 ...
 ```@import "theme/theme_variables";  // 1. Add your variables into this file. Also add variables to overwrite Bootstrap or Paraguas variables here
...
### Classic install
- Download the paraguas folder from GitHub or from [https://paraguas.com](https://paraguas.com)
